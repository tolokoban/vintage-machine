/** @module basic */require( 'basic', function(exports, module) { var _intl_={"fr":{"i-triangle":"TRIANGLE x1, y1, x2, y2, x3, y3","expected-eol":"L'instruction devrait s'arrêter là.","missing-comma":"Il faut séparer les arguments par des virgules.","missing-equal":"Après un nom de variable, il faut mettre un '='.","missing-expression":"J'ai besoin d'une expression : c'est-à-dire un nombre, une chaîne de caractères, une variable, un calcul...","missing-expression-after":"Il me faut une expression après \"$1\".","missing-par-close":"Il manque une paranthèse fermante !","missing-to":"Il faut le mot clef TO dans un FOR pour que ça fonctionne.","missing-var-after-for":"Il faut un nom de variable juste après FOR.","too-few-args":"L'instruction \"$1\" a besoin d'au moins $2 argument(s).","too-many-args":"Cette instruction attend au minimum $1 argument(s), et au maximum $2.","unexpected-next":"Ce NEXT ne correspond à aucun FOR."},"en":{}},_$=require("$").intl;function _(){return _$(_intl_, arguments);}
    "use strict";
