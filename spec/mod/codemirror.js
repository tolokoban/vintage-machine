...
/** @module codemirror */require('codemirror', function (require, module, exports) {
  var _ = function () {
    var D = {
        "en": {},
        "fr": {}
  ...
  module.exports = function () {
      ...
      onContextMenu: function onContextMenu(e) {
        ...
        function rehide() {
          ...
          if (te.selectionStart != null) {
            ...
            var i = 0,
              _poll = function poll() {
                if (display.selForContextMenu == cm.doc.sel && te.selectionStart == 0 && te.selectionEnd > 0 && input.prevInput == "\u200B") operation(cm, commands.selectAll)(cm);else if (i++ < 10) display.detectingSelectAll = setTimeout(_poll, 500);else display.input.reset();
              };
      ...
      if (files && files.length && window.FileReader && window.File) {
        ...
        try {
          ...
          if (text) {
            ...
            if (selected) for (var i = 0; i < selected.length; ++i) _replaceRange(cm.doc, "", selected[i].anchor, selected[i].head, "drag");
    ...
    Doc.prototype = createObj(BranchChunk.prototype, {
      ...
      setSelections: docMethodOp(function (ranges, primary, options) {
        ...
        for (var i = 0, out = []; i < ranges.length; i++) out[i] = new Range(_clipPos(this, ranges[i].anchor), _clipPos(this, ranges[i].head));
    ...
    var off = CodeMirror.off = function (emitter, type, f) {
      if (emitter.removeEventListener) emitter.removeEventListener(type, f, false);else if (emitter.detachEvent) emitter.detachEvent("on" + type, f);else {
        ...
        for (var i = 0; i < handlers.length; ++i) if (handlers[i] == f) {
          handlers.splice(i, 1);
          break;
        }
      }
    ...
    console.log(CodeMirror.defineSim);
    return CodeMirror;
  }();
  module.exports._ = _;
});