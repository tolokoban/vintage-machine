...
/** @module page.sprite */require('page.sprite', function (require, module, exports) {
  var _ = function () {
    var D = {
        "en": {},
        "fr": {}
  ...
  var H = CELLSIZE * 64 + 1;
  var g_symbols;
  var g_palette = [[0, 0, 0], [255, 255, 255], [255, 0, 0], [0, 255, 0], [0, 0, 255], [255, 255, 0], [255, 0, 255], [0, 255, 255]];
  var g_layer = 0;
  var g_x = 0;
  var g_y = 0;
  var g_ctx;
        ...
        for (j = 0; j < 16; j++) {
          for (i = 0; i < 16; i++) {
            for (k = 0; k < 4; k++) {
              ...
              g_symbols[4 * (256 * (row * 16 + j) + col * 16 + i) + k] = g_symbols[4 * (256 * (col * 16 + j) + row * 16 + i) + k];
