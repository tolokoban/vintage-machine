...
/** @module wdg.flex */require('wdg.flex', function (require, module, exports) {
  var _ = function () {
    var D = {
        "en": {}
      },
  ...
  */
  ...
  function Flex(opts) {
    ...
    DB.propString(this, 'justify')(function (v) {
      $.removeClass(elem, 'justify-center', 'justify-flex-end', 'justify-flex-start', 'justify-space-around', 'justify-space-between');
      var cls = null;
